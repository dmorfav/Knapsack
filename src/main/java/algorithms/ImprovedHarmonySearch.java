...
public class ImprovedHarmonySearch {
    ...
    private final double PARmin;
    //Maximum Pitch Adjustment Rate
    private final double PARmax;    
    //Minimum Pitch Adjustment BandWitdh
    private final double BWmin;
    //Maximum Pitch Adjustment BandWitdh
    private final double BWmax;    
    ...
    public ImprovedHarmonySearch(int instSize, Model m) {
        //Setting parameters        
        HMS = 30;
        HMCR = 0.8;
        PARmin = 0.3;
    ...
    private int[] createNewHarmony(int iteration){
        ...
        for(int i=0; i<NVAR; i++){
            if(probabilityRand() <= HMCR){
                ...
                //Self-Adaptative PAR
                double PAR = PARmin+((PARmax-PARmin)/maxIter)*iteration;
    ...
    public int[] HarmonySearchAlgorithm(){
        ...
        while(i < maxIter){
            ...
            int[] newHarmony = createNewHarmony(i);
